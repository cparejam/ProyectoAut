...
def CORREOS = "cparejam@choucairtesting.com"
        ...
        stage('Obtener Fuentes') {
            steps {
                checkout([$class: 'GitSCM', branches: [[name: "main"]],
                          wdoGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: "ProyectoAut", url: "https://github.com/cparejam/ProyectoAut.git"]]])
            }
        }
